...
public class Color
{
    ...
    {
        color = android.graphics.Color.argb(1, Math.round(red), Math.round(green), Math.round(blue));
    }
    ...
    public void setBrightness(float brightness)
    {
        ...
        setRed((int)Math.max(getRed() * scaleFactor * scaleFactor, 255));
        setGreen((int)Math.max(getGreen() * scaleFactor * scaleFactor, 255));
        setBlue((int)Math.max(getBlue() * scaleFactor * scaleFactor, 255));
    }
